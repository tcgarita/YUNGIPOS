...
public class PopupBillInputWindow extends PopupWindow {
	...
	public void setCallback(OrderSectionFragment0 activity)
	{
		try {
	...
	public PopupBillInputWindow(LayoutInflater inflater, Resources resources, int money)
	{
		billMoney = money;
